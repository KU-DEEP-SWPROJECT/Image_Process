...
def get_points():
    ...
    ############################################
        ...
        (marker_corners, marker_id, rejected_markers) = detector.detectMarkers(aruco_image)
    ...
    mapping(k_real_size, turtle_num, burden_real_size, m_color)
